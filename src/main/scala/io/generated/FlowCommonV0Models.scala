 ...
 * apidoc:0.11.75 http://www.apidoc.me/flow/common/0.2.87/scala_models
 */
package io.flow.common.v0.models {
   ...
   */
  sealed trait ExpandableOrganizationDiscriminator
   ...
   */
  sealed trait ExpandableUserDiscriminator
