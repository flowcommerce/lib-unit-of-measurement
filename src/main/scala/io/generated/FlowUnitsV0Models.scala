 ...
 * Service version: 0.17.43
 * apibuilder 0.15.33 app.apibuilder.io/flow/units/latest/scala_models
 */
package io.flow.units.v0.models {
  ...
  object UnitOfVolume {
     ...
     * above.
     */
    val all: scala.List[UnitOfVolume] = scala.List(CubicInch, CubicMeter)
